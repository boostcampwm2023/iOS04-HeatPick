...
extension AlertType {
    ...
    public var message: String {
        ...
        case .didFailToLoadMetadataForEditor: return "스토리 생성에 필요한 사용자 정보를 가져오는데 실패했어요. 확인 버튼을 누르면 이전화면으로 이동해요."
        case .didFailToSaveStory: return "스토리 작성에 실패했어요. 다시 시도하시겠어요?"
        case .didFailToLoadStoryDetail: return "스토리 정보를 가져오는데 실패했어요. 확인 버튼을 누르면 이전화면으로 이동해요."
        ...
        case .didFailToLoadComments: return "댓글을 불러오는데 실패했어요. 확인 버튼을 누르면 이전화면으로 이동해요."
        case .didFailToSaveComment: return "댓글 작성에 실패했어요. 다시 시도하시겠어요?"
        }
    }
