...
final class MyPageTemperatureView: UIView {
    ...
    func setup(title: String, temperature: String) {
        titleLabel.text = title
        contentLabel.attributedText = NSMutableAttributedString(string: "온도가 \(temperature)에요")
            .font(.captionSemibold, text: temperature)
            .foregroundColor(.hpRed2, text: temperature)
    }
